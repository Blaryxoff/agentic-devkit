...
- Commit following [git conventions](./conduct/git.md): Conventional Commits format, one logical change per commit, run project checks (`pnpm lint`, `pnpm typecheck`, related tests, and build checks)
