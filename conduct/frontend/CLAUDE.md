...
3. **[configs.md](conduct/configs.md)** — frontend config patterns and environment usage boundaries
4. **[error_handling.md](conduct/error_handling.md)** — domain/infrastructure error boundaries and user-safe failure behavior
5. **[logging.md](conduct/logging.md)** — structured frontend logging, log levels, and sensitive-data redaction
6. **[stores.md](conduct/stores.md)** — Pinia store rules, when to use stores vs composables
7. **[dependencies.md](conduct/dependencies.md)** — approved third-party libraries by concern, forbidden packages
8. **[documentation.md](conduct/documentation.md)** — documentation standards and update workflow
...
- **[security.md](conduct/security.md)** — input validation, XSS prevention, auth/session hygiene, CORS
