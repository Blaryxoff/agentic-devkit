...
for rule in (
    ...
    "give operator occupancy in hours as its own figure with a one-line itemization",
    ...
    "is elapsed time, because the reader is deciding a date, not buying hours",
    "report elapsed in hours below 16, in working days at or above it, at 8 hours to the working day",
    "hold one unit across a low/likely/high range even when the range straddles that line",
    ...
    "every output item is present, in order, none past three lines",
