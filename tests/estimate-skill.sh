...
for rule in (
    ...
    "every effort figure is hours — operator occupancy, per-lane work, each delta, each shortening option",
    "bare hours invite the reader into the division step 5 forbids",
    "give elapsed in hours under roughly two working days",
    "estimate both in hours",
    "the hours it buys, computed by removing its lanes and recomputing",
