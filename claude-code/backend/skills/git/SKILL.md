---
name: rubx-git
description: enforce git workflow conventions for Laravel/Vue teams (branching, commits, PR/MR quality, release tags)
---
...
- **PR/MR body**: includes Problem, Solution, Risks, Verification steps.
...
When the user asks you to commit or prepare an MR, proactively check these rules and warn about any violations before proceeding.
