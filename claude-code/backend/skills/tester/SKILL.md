...
- If no test-case documents exist, stop and tell the user to run `rubx-test-case-creator` first.
...
- If you discover coverage gaps not addressed by existing test cases, request new test-case creation via `rubx-test-case-creator` — do not invent test cases yourself.
