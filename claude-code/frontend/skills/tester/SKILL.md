...
- If no test-case documents exist, stop and tell user to run `rubx-test-case-creator` first.
...
- If coverage gaps are found, request new test-case creation via `rubx-test-case-creator`.
