...
7. **Cleanup.** `browser-qa-rules.md` §10 — stop only what this pass started, leave seeded records, and close this pass's Chrome by its exact `--user-data-dir` (§10.3). Never glob-kill Chrome (§10.4).
