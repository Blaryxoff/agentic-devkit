...
This document lists common frontend mistakes for Nuxt + TypeScript codebases.
...
## AP-6: Duplicated network calls in multiple components
...
## AP-7: Over-logging and sensitive data leaks
